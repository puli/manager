...
class ProviderFactory
{
    ...
    private static $discoveryProviderClassNames = array(
        'key-value-store' => 'Puli\RepositoryManager\Factory\Discovery\KeyValueStoreDiscoveryRecipeProvider',
    );
    ...
    private static $repositoryProviderClassNames = array(
        'filesystem' => 'Puli\RepositoryManager\Factory\Repository\FilesystemRepositoryRecipeProvider',
    );
    ...
    private static $keyValueStoreProviderClassNames = array(
        null => 'Puli\RepositoryManager\Factory\KeyValueStore\NullStoreRecipeProvider',
        'null' => 'Puli\RepositoryManager\Factory\KeyValueStore\NullStoreRecipeProvider',
        'array' => 'Puli\RepositoryManager\Factory\KeyValueStore\ArrayStoreRecipeProvider',
        'json-file' => 'Puli\RepositoryManager\Factory\KeyValueStore\JsonFileStoreRecipeProvider',
        'php-redis' => 'Puli\RepositoryManager\Factory\KeyValueStore\PhpRedisStoreRecipeProvider',
        'predis' => 'Puli\RepositoryManager\Factory\KeyValueStore\PredisStoreRecipeProvider',
        'riak' => 'Puli\RepositoryManager\Factory\KeyValueStore\RiakStoreRecipeProvider',
    );
    ...
    public function createDiscoveryRecipeProvider($name)
    {
        ...
        if (!is_subclass_of($name,
            'Puli\RepositoryManager\Factory\BuildRecipeProvider')) {
            throw new InvalidArgumentException(sprintf(
