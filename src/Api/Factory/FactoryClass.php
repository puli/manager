...
class FactoryClass
{
     ...
     *
     * @return string[] The imported fully-qualified class names.
     */
     ...
     *
     * @param string[] $classNames The imported fully-qualified class names.
     *
     * @return static The current instance.
     */
    public function setImports(array $classNames)
    {
        $this->imports = array();
     ...
     * @return static The current instance.
     */
    public function addImports(array $classNames)
    {
        foreach ($classNames as $import) {
     ...
     *
     * @param string $className The imported fully-qualified class name.
     *
     * @return static The current instance.
     */
    public function addImport($className)
    {
        ...
        if (in_array($shortClassName, $this->imports, true)) {
            throw new RuntimeException(sprintf(
                'The class "%s" was imported already.',
                $shortClassName
            ));
        }

        $this->imports[$className] = $shortClassName;
