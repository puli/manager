...
use Puli\RepositoryManager\Tests\Factory\Fixtures\TestDiscoveryRecipeProvider;
use Puli\RepositoryManager\Tests\Factory\Fixtures\TestRepositoryRecipeProvider;
...
class PuliFactoryGeneratorTest extends PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->providerFactory = $this->getMockBuilder('Puli\RepositoryManager\Factory\ProviderFactory')
