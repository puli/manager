 ...
 */
class TestDiscoveryGenerator implements FactoryCodeGenerator
{
    public function generateFactoryCode($varName, $outputDir, $rootDir, array $options, GeneratorFactory $generatorFactory)
    {
        ...
        $code->addImport(__NAMESPACE__.'\TestDiscovery');
        $code->addVarDeclaration($varName, $varName.' = new TestDiscovery($repo);');
