...
class InstallInfoTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $installInfo = new InstallInfo('vendor/module', '/path');
        $installInfo->setInstallerName('Composer');

        $this->assertSame('vendor/module', $installInfo->getModuleName());
    ...
    {
        new InstallInfo('vendor/module', 12345);
    }
